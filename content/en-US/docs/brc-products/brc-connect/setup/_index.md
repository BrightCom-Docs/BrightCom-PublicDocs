...
description: "Installation and configuration guide for Brc Connect"
weight: 10
---
...
Before installing Brc Connect, ensure you have:
...
### Setup Pages
- **BRC Connect Setup** - Main configuration interface
- **BRC Connect Source Setup** - Main configuration interface
- **BRC Type Field Setup** - Main configuration interface

### Assisted Setup
This extension includes guided setup procedures to help with initial configuration.
...
1. Search for "Brc Connect" in Business Central
...
*Configuration instructions specific to Brc Connect will be documented here, including:*
...
1. **Check Extension Status:**
   ...
   - Verify Brc Connect shows as "Installed"
