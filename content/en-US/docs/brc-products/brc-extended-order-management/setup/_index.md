...
description: "Installation and configuration guide for Brc Extended Order Management"
weight: 10
---
...
Before installing Brc Extended Order Management, ensure you have:
...
1. **From AppSource:**
   ...
   - Search for "Brc Extended Order Management"
...
1. Search for "Brc Extended Order Management" in Business Central
...
*Configuration instructions specific to Brc Extended Order Management will be documented here, including:*
...
1. **Check Extension Status:**
   ...
   - Verify Brc Extended Order Management shows as "Installed"
