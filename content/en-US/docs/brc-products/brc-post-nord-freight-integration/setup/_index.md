...
description: "Installation and configuration guide for Brc Post Nord Freight Integration"
weight: 10
---
...
Before installing Brc Post Nord Freight Integration, ensure you have:
...
### Setup Pages
- **BRC PND Setup** - Main configuration interface
- **BRC PND Combination Setup** - Main configuration interface
...
1. **From AppSource:**
   ...
   - Search for "Brc Post Nord Freight Integration"
...
1. Search for "Brc Post Nord Freight Integration" in Business Central
...
*Configuration instructions specific to Brc Post Nord Freight Integration will be documented here, including:*
...
1. **Check Extension Status:**
   ...
   - Verify Brc Post Nord Freight Integration shows as "Installed"
